/** Fallback catalog for /booking when API is unavailable. Prefer live catalog endpoints. */
const CDN = 'https://service-catalog-assets.blacklane.com/Service+Catalog+Assets';

/** Product catalog — Business Van only (static fallback). */
...
/** Options shown on /booking — Business Van only. */
export const VEHICLES = VEHICLE_CATALOG;
